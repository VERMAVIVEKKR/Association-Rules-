...
#visualisation
plot(grocerie_rules,method = "scatterplot",jitter=0)
plot(grocerie_rules,method = "grouped matrix")
...
#visualisation
plot(grocerie_rules2,method = "scatterplot",jitter=0)
plot(grocerie_rules2,method = "grouped matrix")
