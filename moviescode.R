...
plot(movies_rules,method = "scatterplot",jitter=0)
plot(movies_rules,method = "grouped matrix")
...
#visualisation
plot(movies_rules2,method = "scatterplot",jitter=0)
plot(movies_rules2,method = "grouped matrix")
